...
class StandardPyramidIlfovController extends Controller
{
  ...
  public function standard()
  {
    ...
    $ilfov_villages = new VillageCounter;
    $standardPyramid->resetPyramid();
    $ilfov_villages = $ilfov_villages->getVillages('Ilfov');
    $standardPyramid->calculatePyramid($ilfov_villages,'Ilfov');
    //end update stats
    ...
    //
    return view('charts/ilfov/standard',['menbar'=>$menbar],$data);
    }
