...
class StandardPyramidDambovitaController extends Controller
{
  ...
  public function standard()
  {
    ...
    $dambovita_villages = new VillageCounter;
    $standardPyramid->resetPyramid();
    $dambovita_villages = $dambovita_villages->getVillages('Dambovita');
    $standardPyramid->calculatePyramid($dambovita_villages,'Dambovita');
    //end update
    //Prepare graphs
    $roms = $this->roms;
    ...
    $api=url('/dambovita_standard_data');
    ...
    //
    return view('charts/dambovita/standard',['menbar'=>$menbar],$data);
    }
