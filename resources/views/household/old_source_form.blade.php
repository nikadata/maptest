      ...
      <form action="{{ $modify == 1 ? route('update_household', ['household_id'=> $household_id ]) : route('create_household') }}" method="post">
            ...
            <div class="col-12" >
              ...
              @if ($modify==1 and $coresident==1)
                ...
                <tr>
                 ...
                 <tr><td>
                   <select name="resident_cat[]" class="form-control form-control-sm" required><option value="{{ $resident->resident_cat }}">{{ $resident->resident_cat }}</option><option value="Aunt">Aunt</option><option value="Child">Child</option><option value="Cousin">Cousin</option><option value="Daughter-in-law">Daughter-in-law</option><option value="Grandparent">Grandparent</option>
                     ...
                     <option value="Son-in-law">Son-in-law</option><option value="Uncle">Uncle</option><option value="Non-relative">Non-relative</option>
                   </select>
                 </td>
                   ...
                   <!-- -->
                   <td><select name="resident_nation[]" class="form-control form-control-sm" required><option value="{{ $resident->resident_nation }}">{{ $resident->resident_nation }}</option><option value="Țigan">Țigan</option><option value="Rudar">Rudar</option><option value="Romanian">Romanian</option><option value="Jewish">Jewish</option><option value="Serbian">Serbian</option>
                     <option value="Albanez/Arnăuțean">Albanez/Arnăuțean</option><option value="Bulgarian">Bulgarian</option>
                 ...
                 <td>
                   <select name="resident_class[]" class="form-control form-control-sm" required><option value="{{$resident->resident_class}}">{{$resident->resident_class}}</option><option value="Arendaș">Arendaș</option><option value="Aurar">Aurar</option><option value="Clăcaș">Clăcaș</option><option value="Craftsman">Craftsman</option><option value="Domestic/servant">Domestic/servant</option>
                     <option value="Estate administrator">Estate administrator</option><option value="Exempted">Exempted</option><option value="Landowner">Landowner</option>
                   </select>
                 </td>
                   <td>
                     <select name="resident_job[]" class="form-control form-control-sm" required><option value="{{$resident->resident_job}}">{{$resident->resident_job}}</option><option value="Arendaș">Arendaș</option><option value="Bear tamer">Bear tamer</option><option value="Blacksmith">Blacksmith</option><option value="Brickmaker">Brickmaker</option><option value="Cattle seller">Cattle seller</option>
                       <option value="Coachman">Coachman</option><option value="Cobza player">Cobza player</option>
                   <option value="Daily laborer">Daily laborer</option><option value="Domestic/servant">Domestic/servant</option><option value="Drum player">Drum player</option><option value="Estate caretaker">Estate caretaker</option><option value="Farmer">Farmer</option><option value="Forester">Forester</option><option value="Gold panner">Gold panner</option>
                   <option value="Lăutar">Lăutar</option><option value="Logofețel">Logofețel</option><option value="Merchant">Merchant</option>
                   <option value="None">None</option><option value="Nurse">Nurse</option><option value="Ploughman">Ploughman</option><option value="Priest">Priest</option><option value="Sexton">Sexton</option><option value="Spoon maker">Spoon maker</option><option value="Tinsmith">Tinsmith</option>
                   <option value="Violin player">Violin player</option><option value="Wheelwright">Wheelwright</option></select></td>
                   <td>
                     <select name="resident_second_job[]" class="form-control form-control-sm" required><option value="{{$resident->resident_second_job}}">{{$resident->resident_second_job}}</option><option value="Arendaș">Arendaș</option><option value="Bear tamer">Bear tamer</option><option value="Blacksmith">Blacksmith</option><option value="Brickmaker">Brickmaker</option><option value="Cattle seller">Cattle seller</option>
                       <option value="Coachman">Coachman</option><option value="Cobza player">Cobza player</option>
                   <option value="Daily laborer">Daily laborer</option><option value="Domestic/servant">Domestic/servant</option><option value="Drum player">Drum player</option><option value="Estate caretaker">Estate caretaker</option><option value="Farmer">Farmer</option><option value="Forester">Forester</option><option value="Gold panner">Gold panner</option>
                   <option value="Lăutar">Lăutar</option><option value="Logofețel">Logofețel</option><option value="Merchant">Merchant</option>
                   <option value="None">None</option><option value="Nurse">Nurse</option><option value="Ploughman">Ploughman</option><option value="Priest">Priest</option><option value="Sexton">Sexton</option><option value="Spoon maker">Spoon maker</option><option value="Tinsmith">Tinsmith</option>
                    ...
                    @foreach( $coresident_spouses as $spouse)
                      @if ( $resident->id==$spouse->coresident_id )
                        <tr>
                          ...
                          <td><select name="spouse_nation[]" class="form-control form-control-sm" required><option value="{{ $spouse->spouse_nation }}">{{ $spouse->spouse_nation }}</option><option value="Țigan">Țigan</option><option value="Rudar">Rudar</option><option value="Romanian">Romanian</option><option value="Jewish">Jewish</option><option value="Serbian">Serbian</option>
                            <option value="Albanez/Arnăuțean">Albanez/Arnăuțean</option><option value="Bulgarian">Bulgarian</option>
                          <option value="Căldărar">Căldărar</option><option value="Ciurar">Ciurar</option><option value="Fierar">Fierar</option><option value="Greek">Greek</option><option value="Inar">Inar</option><option value="Hungarian">Hungarian</option><option value="Lăieș/Lăieț">Lăieș/Lăieț</option>
                          <option value="Moldovean">Moldovean</option><option value="Netot">Netot</option><option value="Oltean">Oltean</option>
                          ...
                          <td><select name="spouse_job[]" class="form-control form-control-sm" required><option value="{{ $spouse->spouse_job }}">{{ $spouse->spouse_job }}</option><option value="Arendaș">Arendaș</option><option value="Bag maker">Bag maker</option><option value="Bear tamer">Bear tamer</option><option value="Blacksmith">Blacksmith</option><option value="Bricklayer">Bricklayer</option>
                            <option value="Brickmaker">Brickmaker</option><option value="Căldărar">Căldărar</option><option value="Carpenter">Carpenter</option><option value="Cartman">Cartman</option><option value="Cattle seller">Cattle seller</option><option value="Church singer">Church singer</option><option value="Coachman">Coachman</option><option value="Cobza player">Cobza player</option>
                            <option value="Cook">Cook</option><option value="Daily laborer">Daily laborer</option><option value="Domestic/servant">Domestic/servant</option><option value="Drum player">Drum player</option><option value="Estate caretaker">Estate caretaker</option><option value="Farmer">Farmer</option><option value="Farrier">Farrier</option>
                          <option value="Forester">Forester</option><option value="Gold panner">Gold panner</option><option value="Grocer">Grocer</option><option value="Innkeeper and grocer">Innkeeper and grocer</option><option value="Lăutar">Lăutar</option><option value="Logofețel">Logofețel</option><option value="Merchant">Merchant</option>
                          <option value="None">None</option><option value="Nurse">Nurse</option><option value="Official">Official</option><option value="Ploughman">Ploughman</option><option value="Priest">Priest</option><option value="Producer of brandy">Producer of brandy</option><option value="Quilt maker">Quilt maker</option>
                          <option value="Rudar">Rudar</option><option value="Schoolmaster">Schoolmaster</option><option value="Sexton">Sexton</option><option value="Shoemaker">Shoemaker</option><option value="Sieve maker">Sieve maker</option><option value="Spader">Spader</option><option value="Spinster">Spinster</option>
                          <option value="Spoon maker">Spoon maker</option><option value="Swine herd">Swine herd</option><option value="Tailor">Tailor</option><option value="Tinsmith">Tinsmith</option><option value="Vătaf">Vătaf</option><option value="Violin player">Violin player</option><option value="Weaver">Weaver</option>
                          <option value="Wheelwright">Wheelwright</option></select></td>
                    ...
                    @foreach( $coresident_children as $residentchild)
                      @if ( $resident->id==$residentchild->coresident_id )
                        <tr>
                          ...
                          <td><select name="resident_child_nation[]" class="form-control form-control-sm" required><option value="{{ $residentchild->child_nation }}">{{ $residentchild->child_nation }}</option><option value="Țigan">Țigan</option><option value="Rudar">Rudar</option><option value="Romanian">Romanian</option><option value="Jewish">Jewish</option><option value="Serbian">Serbian</option>
                            <option value="Albanez/Arnăuțean">Albanez/Arnăuțean</option><option value="Bulgarian">Bulgarian</option>
                          <option value="Căldărar">Căldărar</option><option value="Ciurar">Ciurar</option><option value="Fierar">Fierar</option><option value="Greek">Greek</option><option value="Inar">Inar</option><option value="Hungarian">Hungarian</option><option value="Lăieș/Lăieț">Lăieș/Lăieț</option>
                          <option value="Moldovean">Moldovean</option><option value="Netot">Netot</option><option value="Oltean">Oltean</option>
                          <option value="Ungurean">Ungurean</option><option value="Ursar">Ursar</option><option value="Vătraş">Vătraş</option><option value="Zavragiu">Zavragiu</option><option value="Zlătar">Zlătar</option></select> </td>
       ...
       <!-- End co-residents -->
        ...
        <div class="form-row">
            ...
            <div class="col-2">
            <label>Job</label>
            <select class="form-control form-control-sm" name="skill">
              @if( $modify==1)
            ...
            <select class="form-control form-control-sm" name="second_skill">
              @if( $modify==1)
        ...
        $(document).ready(function(){
          ...
          $(document).on('click', '.resident', function(){
            ...
            html += '<td><select name="resident_cat[]" class="form-control form-control-sm" required><option value="">Relative type</option><option value="Aunt">Aunt</option><option value="Child">Child</option>';
            ...
            html += '<option value="Servant">Servant</option><option value="Sibling">Sibling</option><option value="Son-in-law">Son-in-law</option><option value="Uncle">Uncle</option><option value="Non-relative">Non-relative</option>';
            ...
            html += '<td><select name="resident_nation[]" class="form-control form-control-sm" required><option value="">Nationality</option><option value="Țigan">Țigan</option><option value="Rudar">Rudar</option><option value="Romanian">Romanian</option><option value="Jewish">Jewish</option><option value="Serbian">Serbian</option><option value="Albanez/Arnăuțean">Albanez/Arnăuțean</option><option value="Bulgarian">Bulgarian</option>';
            ...
            html += '<option value="exempted">Exempted</option><option value="landowner">Landowner</option>';
            html += '</select></td>';
            html += '<td><select name="resident_job[]" class="form-control form-control-sm" required><option value="">Job</option><option value="Arendaș">Arendaș</option><option value="Bag maker">Bag maker</option><option value="Bear tamer">Bear tamer</option><option value="Blacksmith">Blacksmith</option><option value="Bricklayer">Bricklayer</option><option value="Brickmaker">Brickmaker</option><option value="Căldărar">Căldărar</option><option value="Carpenter">Carpenter</option><option value="Cartman">Cartman</option><option value="Cattle seller">Cattle seller</option><option value="Church singer">Church singer</option><option value="Coachman">Coachman</option><option value="Cobza player">Cobza player</option>';
            html += '<option value="Cook">Cook</option><option value="Daily laborer">Daily laborer</option><option value="Domestic/servant">Domestic/servant</option><option value="Drum player">Drum player</option><option value="Estate caretaker">Estate caretaker</option><option value="Farmer">Farmer</option><option value="Farrier">Farrier</option><option value="Forester">Forester</option><option value="Gold panner">Gold panner</option><option value="Grocer">Grocer</option><option value="Innkeeper and grocer">Innkeeper and grocer</option><option value="Lăutar">Lăutar</option><option value="Logofețel">Logofețel</option><option value="Merchant">Merchant</option>';
            html += '<option value="None">None</option><option value="Nurse">Nurse</option><option value="Official">Official</option><option value="Ploughman">Ploughman</option><option value="Priest">Priest</option><option value="Producer of brandy">Producer of brandy</option><option value="Quilt maker">Quilt maker</option><option value="Rudar">Rudar</option><option value="Schoolmaster">Schoolmaster</option><option value="Sexton">Sexton</option><option value="Shoemaker">Shoemaker</option><option value="Sieve maker">Sieve maker</option><option value="Spader">Spader</option><option value="Spinster">Spinster</option><option value="Spoon maker">Spoon maker</option><option value="Swine herd">Swine herd</option><option value="Tailor">Tailor</option><option value="Tinsmith">Tinsmith</option><option value="Vătaf">Vătaf</option><option value="Violin player">Violin player</option><option value="Weaver">Weaver</option><option value="Wheelwright">Wheelwright</option></select></td>';
            html += '<td><select name="resident_second_job[]" class="form-control form-control-sm" required><option value="">Second Job</option><option value="Arendaș">Arendaș</option><option value="Bag maker">Bag maker</option><option value="Bear tamer">Bear tamer</option><option value="Blacksmith">Blacksmith</option><option value="Bricklayer">Bricklayer</option><option value="Brickmaker">Brickmaker</option><option value="Căldărar">Căldărar</option><option value="Carpenter">Carpenter</option><option value="Cartman">Cartman</option><option value="Cattle seller">Cattle seller</option><option value="Church singer">Church singer</option><option value="Coachman">Coachman</option><option value="Cobza player">Cobza player</option>';
            html += '<option value="Cook">Cook</option><option value="Daily laborer">Daily laborer</option><option value="Domestic/servant">Domestic/servant</option><option value="Drum player">Drum player</option><option value="Estate caretaker">Estate caretaker</option><option value="Farmer">Farmer</option><option value="Farrier">Farrier</option><option value="Forester">Forester</option><option value="Gold panner">Gold panner</option><option value="Grocer">Grocer</option><option value="Innkeeper and grocer">Innkeeper and grocer</option><option value="Lăutar">Lăutar</option><option value="Logofețel">Logofețel</option><option value="Merchant">Merchant</option>';
            html += '<option value="None">None</option><option value="Nurse">Nurse</option><option value="Official">Official</option><option value="Ploughman">Ploughman</option><option value="Priest">Priest</option><option value="Producer of brandy">Producer of brandy</option><option value="Quilt maker">Quilt maker</option><option value="Rudar">Rudar</option><option value="Schoolmaster">Schoolmaster</option><option value="Sexton">Sexton</option><option value="Shoemaker">Shoemaker</option><option value="Sieve maker">Sieve maker</option><option value="Spader">Spader</option><option value="Spinster">Spinster</option><option value="Spoon maker">Spoon maker</option><option value="Swine herd">Swine herd</option><option value="Tailor">Tailor</option><option value="Tinsmith">Tinsmith</option><option value="Vătaf">Vătaf</option><option value="Violin player">Violin player</option><option value="Weaver">Weaver</option><option value="Wheelwright">Wheelwright</option></select></td>';
            ...
            $(document).on('click', '.resident_spouse', function(){
              ...
              html += '<option value="Căldărar">Căldărar</option><option value="Ciurar">Ciurar</option><option value="Fierar">Fierar</option><option value="Greek">Greek</option><option value="Inar">Inar</option><option value="Hungarian">Hungarian</option><option value="Lăieș/Lăieț">Lăieș/Lăieț</option><option value="Moldovean">Moldovean</option><option value="Netot">Netot</option><option value="Oltean">Oltean</option>';
              html += '<option value="Ungurean">Ungurean</option><option value="Ursar">Ursar</option><option value="Vătraş">Vătraş</option><option value="Zavragiu">Zavragiu</option><option value="Zlătar">Zlătar</option></select></td>';
              html += '<td><select name="spouse_job[]" class="form-control form-control-sm" required><option value="">Job</option><option value="Arendaș">Arendaș</option><option value="Bag maker">Bag maker</option><option value="Bear tamer">Bear tamer</option><option value="Blacksmith">Blacksmith</option><option value="Bricklayer">Bricklayer</option><option value="Brickmaker">Brickmaker</option><option value="Căldărar">Căldărar</option><option value="Carpenter">Carpenter</option><option value="Cartman">Cartman</option><option value="Cattle seller">Cattle seller</option><option value="Church singer">Church singer</option><option value="Coachman">Coachman</option><option value="Cobza player">Cobza player</option>';
              html += '<option value="Cook">Cook</option><option value="Daily laborer">Daily laborer</option><option value="Domestic/servant">Domestic/servant</option><option value="Drum player">Drum player</option><option value="Estate caretaker">Estate caretaker</option><option value="Farmer">Farmer</option><option value="Farrier">Farrier</option><option value="Forester">Forester</option><option value="Gold panner">Gold panner</option><option value="Grocer">Grocer</option><option value="Innkeeper and grocer">Innkeeper and grocer</option><option value="Lăutar">Lăutar</option><option value="Logofețel">Logofețel</option><option value="Merchant">Merchant</option>';
              html += '<option value="None">None</option><option value="Nurse">Nurse</option><option value="Official">Official</option><option value="Ploughman">Ploughman</option><option value="Priest">Priest</option><option value="Producer of brandy">Producer of brandy</option><option value="Quilt maker">Quilt maker</option><option value="Rudar">Rudar</option><option value="Schoolmaster">Schoolmaster</option><option value="Sexton">Sexton</option><option value="Shoemaker">Shoemaker</option><option value="Sieve maker">Sieve maker</option><option value="Spader">Spader</option><option value="Spinster">Spinster</option><option value="Spoon maker">Spoon maker</option><option value="Swine herd">Swine herd</option><option value="Tailor">Tailor</option><option value="Tinsmith">Tinsmith</option><option value="Vătaf">Vătaf</option><option value="Violin player">Violin player</option><option value="Weaver">Weaver</option><option value="Wheelwright">Wheelwright</option></select></td>';
          ...
          $(document).on('click', '.add', function(){
            ...
            $(document).on('click', '.wifeadd', function(){
              ...
              html += '<td><select name="wife_nation" class="form-control form-control-sm" required><option value="">Nationality</option><option value="Țigan">Țigan</option><option value="Albanez/Arnăuțean">Albanez/Arnăuțean</option><option value="Bulgarian">Bulgarian</option><option value="Căldărar">Căldărar</option><option value="Ciurar">Ciurar</option><option value="Fierar">Fierar</option><option value="Greek">Greek</option>';
              html += '<option value="Hungarian">Hungarian</option><option value="Inar">Inar</option><option value="Jewish">Jewish</option><option value="Lăieș/Lăieț">Lăieș/Lăieț</option><option value="Moldovean">Moldovean</option><option value="Netot">Netot</option><option value="Oltean">Oltean</option><option value="Romanian">Romanian</option><option value="Rudar">Rudar</option><option value="Serbian">Serbian</option>';
              html += '<option value="Ungurean">Ungurean</option><option value="Ursar">Ursar</option><option value="Vătraş">Vătraş</option><option value="Zavragiu">Zavragiu</option><option value="Zlătar">Zlătar</option></select></td>';
