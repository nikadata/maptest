            ...
            <!-- End Wifes gender -->
                ...
                <!-- end wife nationality -->
                    @can('isAdmin')
                        <div class="col-1">
                            <label></label>
                            <a class="btn btn-danger btn-sm" href="{{ route('del_wife', ['wife_id'=>$wife->id ]) }}"><i class="far fa-trash-alt"></i></a>
                        </div>
                    @endcan
                @endforeach
                  ...
                  @if ($modify==1 and $has_children==1)
                   ...
                   <tr>
                    ...
                    -->
                        @can('isAdmin')
                            <td>
                                <a class="btn btn-danger btn-sm" href="{{ route('del_child', ['child_id'=>$children->id ]) }}"><i class="far fa-trash-alt"></i></a>
                            </td>
                        @endcan
                    </tr>
                    @endforeach
            ...
            <div class="col-12" >
              ...
              @if ($modify==1 and $coresident==1)
                <p id="has_resident">Resident</p>
                 ...
                 @foreach( $coresidents as $key=>$resident)
                           <tr>
                               <td scope="row">{{ ++$key }}</td>
                 ...
                 <tr><td></td>
                   ...
                   <!-- -->
                       <tr>
                           ...
                           <td scope="row">Diag.Formal</td>
                           <td scope="row">Diag.Informal</td>
                       </tr>
                   <tr>
                 ...
                 <select name="resident_fiscal[]" class="form-control form-control-sm" required><option value="{{$resident->resident_fiscal}}">{{$resident->resident_fiscal}}</option><option value="">Fiscal</option><option value="Boyar slave">Boyar slave</option><option value="Exempt from taxes">Exempt from taxes</option><option value="Monastery slave">Monastery slave</option><option value="Not yet included">Not yet included</option><option value="Princely slave">Princely slave</option>
                     <option value="Ransomed by himself">Ransomed by himself</option><option value="Ransomed by the village">Ransomed by the village</option><option value="Tax payer">Tax payer</option></select></td>
                     <td><select name="resident_illness[]" class="form-control form-control-sm" required><option value="{{ $resident->resident_illness }}">{{ $resident->resident_illness }}</option><option value="None">None</option><option value="Physical illness">Physical</option><option value="Mental illness">Mental</option><option value="Disabilities">Disabilities</option></select></td>
                       <td><input class="form-control form-control-sm" name="resident_diagnosis_formal[]" type="text" value="{{ $resident->resident_diagnosis_formal }}"></td>
                       <td><input class="form-control form-control-sm" name="resident_diagnosis_informal[]" type="text" value="{{ $resident->resident_diagnosis_informal }}"></td>
                       <!-- -->
                       @can('isAdmin')
                           <td>
                               <a class="btn btn-danger btn-sm" href="{{ route('del_resident', ['resident_id'=>$resident->id ]) }}"><i class="far fa-trash-alt"></i></a>
                           </td>
                       @endcan
                 </tr>
                  @if ($coresident_spouse==1)
                    @foreach( $coresident_spouses as $skey=>$spouse)
                      @if ( $resident->id==$spouse->coresident_id )
                        <tr>
                          <td><strong>Spouse</strong> of {{$resident->resident_name}}</td>
                        ...
                        <option value="Vădrar">Vădrar</option><option value="Vătaf">Vătaf</option><option value="Violin player">Violin player</option><option value="Weaver">Weaver</option><option value="Weigher">Weigher</option><option value="Wheelwright">Wheelwright</option><option value="Woolcard worker">Woolcard worker</option>
                        <option value="Zlătar">Zlătar</option></select></td>
                            <td><select name="spouse_illness[]" class="form-control form-control-sm" required><option value="{{ $spouse->spouse_illness }}">{{ $spouse->spouse_illness }}</option><option value="None">None</option><option value="Physical illness">Physical</option><option value="Mental illness">Mental</option><option value="Disabilities">Disabilities</option></select></td>
                            <td><input class="form-control form-control-sm" name="spouse_diagnosis_formal[]" type="text" value="{{ $spouse->spouse_diagnosis_formal }}"></td>
                            <td><input class="form-control form-control-sm" name="spouse_diagnosis_informal[]" type="text" value="{{ $spouse->spouse_diagnosis_informal }}"></td>
                            @can('isAdmin')
                                <td>
                                    <a class="btn btn-danger btn-sm" href="{{ route('del_resident_spouse', ['spouse_id'=>$spouse->id ]) }}"><i class="far fa-trash-alt"></i></a>
                                </td>
                            @endcan
                        </tr>
                        @endif
                  ...
                  @if ($coresident_child==1)
                    @foreach( $coresident_children as $residentchild)
                      @if ( $resident->id==$residentchild->coresident_id )
                        <tr>
                          <td><strong>Child {{$coresident_child++}}</strong> of Resident: {{$resident->resident_name}}</td>
                          ...
                          <option value="Moldovean">Moldovean</option><option value="Netot">Netot</option><option value="None">None</option><option value="Oltean">Oltean</option>
                          <option value="Ungurean">Ungurean</option><option value="Ursar">Ursar</option><option value="Vătraş">Vătraş</option><option value="Zavragiu">Zavragiu</option><option value="Zlătar">Zlătar</option></select> </td>
                            <td><select name="resident_child_illness[]" class="form-control form-control-sm" required><option value="{{ $residentchild->child_illness }}">{{ $residentchild->child_illness }}</option><option value="None">None</option><option value="Physical illness">Physical</option><option value="Mental illness">Mental</option><option value="Disabilities">Disabilities</option></select></td>
                            <td><input class="form-control form-control-sm" name="resident_child_diagnosis_formal[]" type="text" value="{{ $residentchild->child_diagnosis_formal }}"></td>
                            <td><input class="form-control form-control-sm" name="resident_child_diagnosis_informal[]" type="text" value="{{ $residentchild->child_diagnosis_informal }}""></td>
                            @can('isAdmin')
                                <td>
                                    <a class="btn btn-danger btn-sm" href="{{ route('del_resident_child', ['residentchild_id'=>$residentchild->id ]) }}"><i class="far fa-trash-alt"></i></a>
                                </td>
                            @endcan
                        </tr>
                        @endif
        ...
        $(document).ready(function(){
          ...
          $(document).on('click', '.resident', function(){
            ...
            //if (x<2) {
                ...
                html += '<td scope="row">Age</td><td scope="row">Civilstatus</td><td scope="row">Nationality</td>';
                html += '</tr>';
            //}
            ...
            html += '<td><select name="resident_nation[]" class="form-control form-control-sm" required><option value="Țigan">Țigan</option><option value="None">None</option><option value="Rudar">Rudar</option><option value="Russian">Russian</option><option value="Romanian">Romanian</option><option value="Jewish">Jewish</option><option value="Serbian">Serbian</option><option value="Țigan Ungurean">Țigan Ungurean</option>';
            html += '<option value="Albanez/Arnăuțean">Albanez/Arnăuțean</option><option value="Bulgarian">Bulgarian</option>';
            html += '<option value="Căldărar">Căldărar</option><option value="Ciurar">Ciurar</option><option value="Fierar">Fierar</option><option value="Greek">Greek</option><option value="Inar">Inar</option><option value="Hungarian">Hungarian</option><option value="Lăieș/Lăieț">Lăieș/Lăieț</option><option value="Moldovean">Moldovean</option><option value="Netot">Netot</option>';
            html += '<option value="Oltean">Oltean</option><option value="Ungurean">Ungurean</option><option value="Ursar">Ursar</option><option value="Vătraş">Vătraş</option><option value="Zavragiu">Zavragiu</option><option value="Zlătar">Zlătar</option>';
            html += '</select></td>';
            html += '</tr>';
              //Header part 2
              //if (x<2) {
                  html += '<tr><td scope="row">Class</td>';
                  html += '<td scope="row">Job</td><td scope="row">Second Job</td><td scope="row">Fiscal</td><td scope="row">Illness</td>';
                  html += '<td scope="row">Diag.Formal</td><td scope="row">Diag.Informal</td></tr>';
              //}
            //Entry part 2
            html += '<tr>';
            ...
            html +='<td><input class="form-control form-control-sm" name="resident_diagnosis_formal[]" type="text"></td>';
            html +='<td><input class="form-control form-control-sm" name="resident_diagnosis_informal[]" type="text"></td>';
            html +='<td><button type="button" name="resident_spouse" class="btn btn-outline-primary btn-sm resident_spouse">Spouse<i class="fas fa-user-plus"></i></button></td>';
            html +='<td><button type="button" name="resident_child" class="btn btn-outline-primary btn-sm resident_child">Child<i class="fas fa-user-plus"></i></button></td>';
            ...
            $(document).on('click', '.residentremove', function(){
             //$(this).closest('tr').remove();
                ...
                var secondClosest = closestRow.add(closestRow.prev()).add(closestRow.next());
                var thirdClosest = secondClosest.add(secondClosest.prev()).add(secondClosest.next());
                thirdClosest.add(thirdClosest.prev()).add(thirdClosest.next()).remove();
            ...
            $(document).on('click', '.resident_spouse', function(){
              ...
              html += '<td><select name="spouse_job[]" class="form-control form-control-sm" required><option value="None">None</option><option value="Achari">Achari</option><option value="Arendaș">Arendaș</option><option value="Bag maker">Bag maker</option><option value="Baker">Baker</option><option value="Barber">Barber</option>';
              html += '<option value="Bear tamer">Bear tamer</option><option value="Blacksmith">Blacksmith</option><option value="Bootmaker">Bootmaker</option><option value="Bricklayer">Bricklayer</option><option value="Brickmaker">Brickmaker</option><option value="Buffalo caretaker">Buffalo caretaker</option><option value="Căldărar">Căldărar</option>';
              html += '<option value="Carpenter">Carpenter</option><option value="Cartman">Cartman</option><option value="Cattle seller">Cattle seller</option>';
              html += '<option value="Church singer">Church singer</option><option value="Coachman">Coachman</option><option value="Cobza player">Cobza player</option>';
              html += '<option value="Comb maker">Comb maker</option><option value="Cook">Cook</option><option value="Cowherd">Cowherd</option><option value="Daily laborer">Daily laborer</option><option value="Domestic/servant">Domestic/servant</option><option value="Drum player">Drum player</option><option value="Estate caretaker">Estate caretaker</option>';
              ...
              html += '<option value="Vădrar">Vădrar</option><option value="Vătaf">Vătaf</option><option value="Violin player">Violin player</option><option value="Weaver">Weaver</option><option value="Weigher">Weigher</option><option value="Wheelwright">Wheelwright</option><option value="Woolcard worker">Woolcard worker</option>';
              html += '<option value="Zlătar">Zlătar</option></select></td>';
              html +='<td><select name="spouse_illness[]" class="form-control form-control-sm" required><option value="">Illness</option><option value="None">None</option><option value="Physical illness">Physical</option><option value="Mental illness">Mental</option><option value="Disabilities">Disabilities</option></select></td>';
                html +='<td><input class="form-control form-control-sm" name="spouse_diagnosis_formal[]" type="text" placeholder="Diag.Formal"></td>';
                html +='<td><input class="form-control form-control-sm" name="spouse_diagnosis_informal[]" type="text" placeholder="Diag.Informal"></td>';
             ...
             $(document).on('click', '.spouseremove', function(){
              ...
              $(document).on('click', '.resident_child', function(){
                  ...
                  html +='<td><input class="form-control form-control-sm" name="resident_child_diagnosis_formal[]" type="text" placeholder="Diag.Formal"></td>';
                  html +='<td><input class="form-control form-control-sm" name="resident_child_diagnosis_informal[]" type="text" placeholder="Diag.Informal"></td>';
