...
<div class="form-row">
      <div class="col">
        ...
        <!--Trade/occupation -->
        <div class="form-group">
        <label for="Trade" class="text-primary">Trade/occupation</label>
        <div class="form-row">
          <?php $x=0;?>
          @foreach ($skills as $skill)
          <div class="col-sm-2 pb-3">
            <label>{{$skill->skill_name}}</label>
            <input name="job[]" class="form-control form-control-sm" type="number" value="{{ old('store') ? old('store'): $store[$x] }}" required>
